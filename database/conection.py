...
class Database:
    ...
    def get_tabela(self):
        try:
            if session['empresa'] == 1:
                ...
                return "faturamento_portal"
            elif session['empresa'] == 3:
                return "faturamento_morumbi"
        except Exception as e:
            # Loga o erro detalhado
            logging.error("Erro ao cadastrar faturamento: %s", e)
    ...
    def cadastrar_faturamento(self, dados):
        ...
        try:
            ...
            self.cursor.execute(query, (
                ...
                dados['valor_servico_transmissao'], dados['usuario'], dados['obs'], dados['terceiros']
            ))
    ...
    def faturamento_mes(self, mes, ano):
        try:
            ...
            tabela = self.get_tabela()
            query = f'SELECT valor_os FROM {tabela} WHERE mes_faturamento = ? AND ano_faturamento = ?'
    ...
    def faturamento_mes_meta(self, mes, ano):
        try:
            ...
            tabela = self.get_tabela()
            query = f'SELECT valor_meta FROM {tabela} WHERE mes_faturamento = ? AND ano_faturamento = ?'
            self.cursor.execute(query, (mes, ano))
            result = self.cursor.fetchall()
    ...
    def get_mecanicos(self, empresa):
        """
        ...
        try:
            ...
            funcao = 'mecanico'
            query = 'SELECT nome FROM colaboradores where filial_id = ? AND funcao = ? ORDER BY nome ASC;'
            self.cursor.execute(query, empresa, funcao)
            result = self.cursor.fetchall()
    ...
    def faturamento_serv(self, serv, mes, ano):
        ...
        try:
            ...
            query = f'SELECT {serv} FROM {tabela} WHERE mes_faturamento = ? AND ano_faturamento = ?'
    ...
    def faturamento_geral(self):
        ...
        try:
            ...
            tabela = self.get_tabela()
            # Montando e executando a query SQL
            query = f'SELECT * FROM {tabela} ORDER BY data_faturamento ASC;'
            self.cursor.execute(query)
            result = self.cursor.fetchall()
    ...
    def faturamento_pecas(self, mes, ano):
        ...
        try:
            ...
            tabela = self.get_tabela()
            # Montando e executando a query SQL
            query = f'SELECT pecas FROM {tabela} WHERE mes_faturamento = ? AND ano_faturamento = ?'
            self.cursor.execute(query, (mes, ano))
            result = self.cursor.fetchall()
    ...
    def faturamento_servicos(self, mes, ano):
        ...
        try:
            ...
            tabela = self.get_tabela()
            # Montando e executando a query SQL
            query = f'SELECT servicos FROM {tabela} WHERE mes_faturamento = ? AND ano_faturamento = ?'
            self.cursor.execute(query, (mes, ano))
            result = self.cursor.fetchall()
    ...
    def faturamento_dinheiro(self, mes, ano):
        ...
        try:
            ...
            tabela = self.get_tabela()
            # Montando e executando a query SQL
            query = f'SELECT valor_dinheiro FROM {tabela} WHERE mes_faturamento = ? AND ano_faturamento = ?'
            self.cursor.execute(query, (mes, ano))
            result = self.cursor.fetchall()
    ...
    def faturamento_dinheiro_ordens(self, mes, ano):
        ...
        try:
            ...
            tabela = self.get_tabela()
            # Montando e executando a query SQL
            query = f'SELECT * FROM {tabela} WHERE mes_faturamento = ? AND ano_faturamento = ? ORDER BY data_faturamento ASC;'
            self.cursor.execute(query, (mes, ano))
            result = self.cursor.fetchall()
    ...
    def buscar_os_by_number(self, num_os):
        ...
        try:
            ...
            self.cursor.execute(f'SELECT * FROM {tabela} WHERE num_os = ?', (num_os,))
    ...
    def buscar_faturamento(self, num_os):
        ...
        try:
            ...
            tabela = self.get_tabela()
            query = f'SELECT * FROM {tabela} WHERE num_os = ?'
    ...
    def detalhes_filtros(self, mes, ano, mecanico):
        try:
            ...
            tabela = self.get_tabela()
            query = f'SELECT * FROM {tabela} WHERE mes_faturamento = ? AND ano_faturamento = ? AND filtro_mecanico = ?'
    ...
    def detalhes_revitalizacao(self, mes, ano, mecanico):
        try:
            ...
            tabela = self.get_tabela()
            query = f'SELECT * FROM {tabela} WHERE mes_faturamento = ? AND ano_faturamento = ? AND mecanico = ?'
    ...
    def ordens(self, mes, ano):
        try:
            ...
            tabela = self.get_tabela()
            query = f'SELECT * FROM {tabela} WHERE mes_faturamento = ? AND ano_faturamento = ?'
    ...
    def funcionarios_por_loja(self, loja):
        ...
        try:
            ...
            query = f'SELECT nome FROM colaboradores ORDER BY nome ASC;'
            self.cursor.execute(query)
            result = self.cursor.fetchall()
