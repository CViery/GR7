...
class UttilsGr7Morumbi:
    def __init__(self):
        self.db = conection.DatabaseMorumbi()
        self.db_gastos = gastos_db.GastosDataBaseMorumbi()
        self.db_dados_notas = dados_notas.DadosGastosMorumbi()
        self.faturamento_db = faturamento.FaturamentoMorumbi()
